...
urlpatterns = [
    ...
    path("manage/settings/mark-policy-updated/", views.manage_mark_policy_updated, name="manage_mark_policy_updated"),
    ...
    path("manage/<slug:slug>/set-cap/", views.manage_session_set_cap, name="manage_session_set_cap"),
