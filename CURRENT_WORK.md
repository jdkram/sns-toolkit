...
| 9.86 | Volunteer opt-in directory | 🔵 S (spec) | Per-volunteer controls: share full name / first+initial / nothing; email; phone; pronouns; access rider; collectives. Public directory page for authenticated users. See TASKS.md 9.86 for design notes. |
