...
| **9.74** | **Permission model redesign** | **🟡 M** | Go ahead — no collective discussion needed. Only Panopticon should have volunteer/member PII. The opt-in volunteer directory covers genuine needs for contact details. Programmers: programme data only. See TASKS.md 9.74. |
