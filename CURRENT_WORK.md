...
| 9.90 | Access transparency: privileged user list + rights explanation | 🔵 S | **Green-lit.** High impact, low effort. MVP: visible list of Panopticon/Programmer users + plain-language rights table. Gate behind Labs SiteSettings. `PanopticonGrant` model for reason + annual review. See TASKS.md 9.90. |
