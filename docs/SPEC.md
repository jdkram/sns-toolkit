...
10–12. [Rewrite strategy, technology notes, and data migration](REWRITE_STRATEGY.md) — moved to a dedicated file
...
## 10–12. Rewrite strategy, technology notes, and data migration

This content has been moved to [REWRITE_STRATEGY.md](REWRITE_STRATEGY.md). That file covers: technology choices for a rewrite, what to keep vs change, the rewrite-vs-continue recommendation, and how to migrate data to a new system (including the HTML scraping fallback).
